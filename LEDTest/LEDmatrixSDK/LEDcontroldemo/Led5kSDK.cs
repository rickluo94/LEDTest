...
namespace LEDmatrixSDK
{
    public class Led5kSDK
    {
        ...
        public class bx5k_err
        {
            ...
            public const int ERR_COMMUNICATE = 100;//通訊失敗
            public const int ERR_PROTOCOL = 101;//協議資料不正確
            public const int ERR_TIMEOUT = 102;//通訊超時
            public const int ERR_NETCLOSE = 103;//通訊斷開
            public const int ERR_INVALID_HAND = 104;//無效控制代碼
            public const int ERR_PARAMETER = 105;//引數錯誤
            public const int ERR_SHOULDREPEAT = 106;//需要重複上次資料包
            public const int ERR_FILE = 107;//無效檔案
        }
        ...
        public struct bx_5k_table
        {
            ...
            public byte CellDataRow0;//一個位元組
    ...
    public class Led5kstaticArea
    {
        ...
        {
            //計算header的大小：結構體bx_5k_area_header的大小
            LEDmatrixSDK.Led5kSDK.bx_5k_area_header tu = new Led5kSDK.bx_5k_area_header();
    ...
    public class Led5kProgram
    {
        ...
        public int SendProgram(uint hand)
        {
            ...
            int sum = 0;
            foreach (LEDmatrixSDK.Led5kstaticArea s in m_arealist)
            {
                sum += s.getAreaLen();
            }
            ...
            return LEDmatrixSDK.Led5kSDK.OFS_SendFileData(hand, 1, ppFileName, DisplayType, PlayTimes, ProgramLife,
    ...
    public class Led5kDynamics
    {
        ...
        public int SendAreas(uint hand)
        {
            ...
            int sum = 0;
            foreach (LEDmatrixSDK.LedstaticArea s in m_arealist)
            {
                sum += s.getAreaLen();
                AreaNum++;
            }
            ...
            TextLen = sum;
            return LEDmatrixSDK.Led5kSDK.SCREEN_SendDynamicAreas(hand, AreaNum, (ushort)TextLen, AreaText);
        }
    }
